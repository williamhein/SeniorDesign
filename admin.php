        ...
        <div id="waterSchedule" style="color: black;">
            ...
            <p style="font-size: 50px; color: white;">
                <span style="font-weight: lighter;">
                    Start Time:
                    <input id = "r1hs" type="text" class="dial" data-min="1" data-max="12" data-height="120px" data-fgColor="#b2db94" value="12">
                    :
                    <input id = "r1ms" type="text" class="dial" data-min="0" data-max="59" data-height="120px" data-fgColor="#b2db94" value="0">
                    ...
                    <br>
                    End Time:
                    <input id = "r1he" type="text" class="dial" data-min="1" data-max="12" data-height="120px" data-fgColor="#b2db94" value="12">
                    :
                    <input id = "r1me" type="text" class="dial" data-min="0" data-max="59" data-height="120px" data-fgColor="#b2db94" value="15">
