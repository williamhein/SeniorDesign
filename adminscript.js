...
function toggle(msg = "") { //toggle for the admin mode
    ...
    if (msg == "Incorrect password." || msg == "User not signed in.") {alert('Incorrect password, sending back to login.');window.location.reload(forceget);}
}

function toggle1(msg = "") {
    var blur1 = document.getElementById('blur');
    blur1.classList.toggle('active');  //when the gear is clicked, the blur is initiated
    var popup1 = document.getElementById('popup1');
    popup1.classList.toggle('active');
    if (msg != "") document.getElementById("popup1Label").innerHTML = msg;
}
...
function addRow(sh = 12, sm = 0, eh = 12, em = 15, ams = true, ame = true) {
   ...
   +'            <input id = "r'+ numOfRows + 'hs" type="text" class="dial" data-min="1" data-max="12" data-height="110px" data-fgColor="#b2db94" data-inputColor="white" value="'+ sh + '">'
   +'             '
   +'            <input id = "r'+ numOfRows + 'ms" type="text" class="dial" data-min="0" data-max="59" data-height="110px" data-fgColor="#b2db94" data-inputColor="white" value="'+ sm + '">'
   ...
   +'        <br>'
   +'        <span style="font-weight: lighter;font-size: 140px; color: white;">'
   +'            <input id = "r'+ numOfRows + 'he" type="text" class="dial" data-min="1" data-max="12" data-height="110px" data-fgColor="#b2db94" data-inputColor="white" value="'+ eh + '">'
   +'             '
   +'            <input id = "r'+ numOfRows + 'me" type="text" class="dial" data-min="0" data-max="59" data-height="110px" data-fgColor="#b2db94" data-inputColor="white" value="'+ em + '">'
